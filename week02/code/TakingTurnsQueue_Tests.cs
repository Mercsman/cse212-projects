...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: It runs into an error with the name comparisons. 
    ...
    // Defect(s) Found: Another Name comparison error
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Still name comparison error. 
    ...
    // Defect(s) Found: Name comparison error
